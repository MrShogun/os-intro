...
3) Проделал приведённые ниже упражнения; все наименования относительно домашней директории:
    1. Просмотрел содержимое файла /etc/passwd (команда "cat").
...
![04](image/01.png)
    ...
    8. Попытавшись скопировать файл ("cp"), копирование не произойдёт, так как копирование входит в права чтения (которых лишились).
...
![05](image/01.png)
    ...
    12. Вернул владельцу (u) каталога play права на выполнение ("chmod u+x").
